# 1 "E:/Ivan/XC8/PowerReg/PZ/hd44780.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 288 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "E:/Ivan/XC8/PowerReg/PZ/hd44780.c" 2
...
# 5 "E:/Ivan/XC8/PowerReg/PZ/hd44780.h" 2
...
# 8 "E:/Ivan/XC8/PowerReg/PZ/hd44780.c" 2
...
void lcdNibble(uint8_t nibble) {
    LATCbits.LC0 = (nibble & 0x01) ? 1 : 0;
    LATCbits.LC1 = (nibble & 0x02) ? 1 : 0;
    LATCbits.LC2 = (nibble & 0x04) ? 1 : 0;
    LATCbits.LC3 = (nibble & 0x08) ? 1 : 0;
