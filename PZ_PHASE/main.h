...
#define SETCCP1(x)  {CCPR1L = (x & 0xFF); CCPR1H = (x >> 8);}
#define SETCCP2(x)  {CCPR2L = (x & 0xFF); CCPR2H = (x >> 8);}
#define SETTMR1(x)  {TMR1L = (x & 0xFF); TMR1H = (x >> 8);}

//#define TMR0L_V 76
#define TMR0L_V 16  //57
#define TRIAC LATAbits.LA5 // управління симістором
#define ZERO 10 // кількість переходів через 0 для вимірювання (має бути парним числом!!!)
#define TRIAC_B LATCbits.LATC4
#define SOUND LATCbits.LATC5
#define MAX_ANGLE 18000 // максимальний кут відкриття симістора 20000 - 1600 18400
#define STEP_ANGLE_1 1
#define STEP_ANGLE_5 5
#define STEP_ANGLE_10 10
#define STEP_ANGLE_50 50
...
extern uint32_t U_summTriac;// сума квадратів вихідної напруги
extern uint8_t triacON;// чи ввімкнений тріак
