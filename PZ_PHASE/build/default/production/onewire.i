...
presence = PORTBbits.RB7;
_delay((unsigned long)((424)*(64000000/4000000.0)));
return(presence);
}
...
PORTBbits.RB7 = 1;
TRISBbits.TRISB7 = 1;
_delay((unsigned long)((6)*(64000000/4000000.0)));
...
_delay((unsigned long)((105)*(64000000/4000000.0)));
PORTBbits.RB7 = 1;
TRISBbits.TRISB7 = 1;
}
...
_delay((unsigned long)((120)*(64000000/4000000.0)));
}
...
void Waiting_WR (void)
{
_delay((unsigned long)((52)*(64000000/4000000.0)));
}
