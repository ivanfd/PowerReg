...
TMR1ON = 0;
{TMR1L = (tmrtmp & 0xFF); TMR1H = (tmrtmp >> 8);};
TMR1ON = 1;
...
(power_100) ? LATAbits.LA5 = 1 : LATAbits.LA5 = 0;
triacON = 0;
TMR1H = 0;
TMR1L = 0;
{CCPR1L = (angle_U_ocr & 0xFF); CCPR1H = (angle_U_ocr >> 8);};
if (zero < 10)
zero++;
if (getU == 1) {
getU = 0;
...
U_summ += U_meas*U_meas;
if (triacON)
U_summTriac += U_meas * U_meas;
cnt_adc++;
}
stab++;
PIR1bits.ADIF = 0;
